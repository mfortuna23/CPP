...
/*   Updated: 2025/06/03 11:54:49 by mfortuna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string&target){
	if (energyPoints < 1){
		std::cout << MAGENTA << "ClapTrap " << name << " has no energy left" << RESET << std::endl;
		return ;
	}
...
void ClapTrap::takeDamage(unsigned int amount){
	...
	if ((int)amount > hitPoints)
		amount = amount - hitPoints;
	std::cout << RED << "ClapTrap " << name << " took " << amount 
...
void ClapTrap::beRepaired(unsigned int amount){
	if (energyPoints == 0){
		std::cout << RED << "ClapTrap " << name << " has 0 points of Energy" << RESET << std::endl;
		return ;
	}
